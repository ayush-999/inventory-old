                                            ...
                                            @foreach ($suppliers as $supplier)
                                             <tr>
                                                ...
                                                <td class="align-middle">
                                                    <img src="{{ url('/uploads/supplier/' . $supplier->image) }}" class="img-fluid table_img" alt="Supplier Image">
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <button type="button" class="btn btn-danger delete" data-toggle="modal" data-target="#exampleModal" id="{{ $supplier->id }}">
                                                      Delete
                                                    </button>
                                                </td>
                                             </tr>
